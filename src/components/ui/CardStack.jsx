...
/** signed offset from active index to i, with wrapping (for loop behavior). */
            ...
            {items.map((item, i) => {
              ...
              return (
                <motion.div
                  key={item.id}
                  className={cn(
                    "absolute bottom-0 rounded-[20px] overflow-hidden",
                    "shadow-[0_30px_70px_rgba(0,0,0,0.2),0_10px_25px_rgba(0,0,0,0.1)]",
